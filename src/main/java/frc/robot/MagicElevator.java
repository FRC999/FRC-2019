...
/**
 * This class is to enable PID control of the elevator. It is untested, because
 * *someone* needs to give us a working elevator. WARNING: GEARBOX ON COMP-BOT
 * IS DIFFERENT THAN SISTER-BOT
 */
public class MagicElevator extends MagicPIDMotor {
  ...
  // circumference is pi * 2.54 * 2; In centimeters: Spool was measured at 1 inch
  // radius
  ...
  /**
   * Check if the elevator button is pressed: if yes, update Includes min/max
   * validation Does not initiate motion
   *
   */
